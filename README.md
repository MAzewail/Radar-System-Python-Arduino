...
This project is licensed under the [MIT License](https://github.com/MAzewail/Radar-System-Python-Arduino/blob/main/LICENSE.txt). Feel free to use, modify, and distribute the code as permitted by the license.
